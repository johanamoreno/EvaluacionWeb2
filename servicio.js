...
function pedirCanciones(token) {
    let uri = "https://api.spotify.com/v1/artists/0EmeFodog0BfCgMzAIvKQp/top-tracks?market=us";
    let parametrosPeticion = {
        method: "GET",
        headers: {
            Authorization: token
    ...
    function pintarDatos(datos) {
        ...
        datos.forEach(function (cancion) {
            ...
            popularidad.textContent = "Porcentaje de Popularidad : " + cancion.popularity + "%";
